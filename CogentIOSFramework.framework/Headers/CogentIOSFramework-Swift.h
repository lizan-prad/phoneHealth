...
#ifndef COGENTIOSFRAMEWORK_SWIFT_H
#define COGENTIOSFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CogentIOSFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC18CogentIOSFramework19ChipButtonValidator")
@interface ChipButtonValidator : NSObject
...
- (void)onCogentPaymentSuccessWithInfo:(NSDictionary<NSString *, id> * _Nonnull)info;
- (void)onCogentPaymentErrorWithErrorDescription:(NSString * _Nonnull)errorDescription;
@end
...
SWIFT_CLASS("_TtC18CogentIOSFramework16SPStorkCloseView")
...
SWIFT_PROTOCOL("_TtP18CogentIOSFramework32SPStorkControllerConfirmDelegate_")
...
SWIFT_PROTOCOL("_TtP18CogentIOSFramework25SPStorkControllerDelegate_")
...
SWIFT_CLASS("_TtC18CogentIOSFramework20SPStorkIndicatorView")
...
SWIFT_CLASS("_TtC18CogentIOSFramework28SPStorkTransitioningDelegate")
...
SWIFT_CLASS("_TtC18CogentIOSFramework9ViewPager")
@interface ViewPager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface ViewPager (SWIFT_EXTENSION(CogentIOSFramework)) <UIPageViewControllerDataSource>
...
@interface ViewPager (SWIFT_EXTENSION(CogentIOSFramework)) <UIPageViewControllerDelegate>
...
@interface ViewPagerTabView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
